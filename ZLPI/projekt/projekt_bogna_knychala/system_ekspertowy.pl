...
main :-
    ...
    write('Odpowiadaj na nie T dla tak lub N dla nie'),nl,nl,
    wyczyscPamiec,
    pytanie.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% Czyszczenie informacji o wszesniejszych odpowiedziach %%%%%%%%
wyczyscPamiec :-
    retract(facts(_,_)),
    fail.
wyczyscPamiec.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% Zadawanie pytania i zbieranie odpowiedzi %%%%%%%%%%%%
...
get_yes_or_no(Odp) :-
    nl,
    put(7),
    write('Wpisuj tylko T lub N:'),
    get_yes_or_no(Odp).

%%%%% kodowanie w ASCI pobranych znakow %%%%%%%
interpret(84,yes).
interpret(116,yes).
interpret(78,no).
interpret(110,no).
